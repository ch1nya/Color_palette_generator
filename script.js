(function () {
  ...
  // Color variables
  let rotation, baseColor, secondColor, thirdColor, lightBackground;
  ...
  // Helper functions
  let getRotation = function () {
    let r = document.getElementById("rotate").value;
  ...
  let Color = function (hue, sat, light) {
    // Settings
